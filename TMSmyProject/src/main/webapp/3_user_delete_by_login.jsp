...
<%
    ...
    pageContext.setAttribute("namecommand", Constants.COMMAND_DELETE_USER_BY_LOGIN);
%>
...
<div class="container-fluid" id="form">
    <form class="row g-3" action=${pageScope.path} method="post">
        ...
        <div class="col-12">
            <button class="btn btn-primary" type="submit" name=${pageScope.command} value=${pageScope.namecommand}>
                Submit form
            </button>
        </div>
    </form>
